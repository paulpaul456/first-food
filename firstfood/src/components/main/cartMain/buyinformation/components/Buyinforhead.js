...
class Buyinforhead extends Component {
  constructor() {
    super()
  }
  render() {
    return (
      <>
        <div className="buy-imf-head">
          <svg
            className="buy-imf-head-svg"
          ...
          <p className="buy-imf-head-p1">付款方式</p>

          <p className="buy-imf-head-p2">
...
export default connect(mapstatetoprops)(Buyinforhead)
