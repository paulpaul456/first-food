...
class Mycartitem extends Component {
  ...
  select(event, e) {
    ...
    this.props.dispatch(selectdata({ checked: event.target.checked, e: e }))
  ...
  deleteitem(e) {
    confirmAlert({
      ...
      buttons: [
        {
          label: '確定',
          onClick: () => this.props.dispatch(deletedata(e)),
        },
        {
          label: '取消',
          onClick: () => {},
  ...
  nextbuy = id => () => {
    confirmAlert({
      ...
      buttons: [
        {
          label: '確定',
          onClick: () => this.props.dispatch(joinNextBuy(id)),
        },
        {
          label: '取消',
          onClick: () => {},
                ...
                <div className="section1-cart-list-left-1">
                  <div className="section1-cart-list-left-image">
                    <img
                      ...
                      src={'/assets/images/goods/' + JSON.parse(e.picture)[0]} //拿下來的是JSON字串 要先轉為JS陣列
                      alt=""
                    />
                  </div>
                  <div className="product-category">{e.name}</div>
                </div>
                <div className="section1-cart-list-left-4p">
                  <p onClick={this.submit}>COA00120</p>
                  <p>
                    顏色:{e.color}
                    <br /> 產地:{e.place}
                  </p>
                ...
                <div className="section1-cart-list-right">
                  ...
                  <div>
                    ...
                    <div
                      ...
                      onClick={this.nextbuy(e.fm_goods_cart_id)}
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="122"
...
export default connect(mapstatetoprops)(Mycartitem)
