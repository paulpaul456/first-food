...
class Mydn extends Component {
  ...
  select(event, e) {
    ...
    this.props.dispatch(dnselectdata({ checked: event.target.checked, e: e }))
  ...
  addone(e) {
    e.quantity++
    this.props.dispatch(dnsetdata(e))
  }
  reduceone(e) {
    if (e.quantity > 0) {
      e.quantity--
  ...
  deleteitem(e) {
    confirmAlert({
      ...
      buttons: [
        {
          label: '確定',
          onClick: () => this.props.dispatch(dndeletedata(e)),
        },
        {
          label: '取消',
          onClick: () => {},
  ...
  nextbuy = id => () => {
    ...
    confirmAlert({
      ...
      buttons: [
        {
          label: '確定',
          onClick: () => this.props.dispatch(dnJoinNextBuy(id)),
        },
        {
          label: '取消',
          onClick: () => {},
  ...
  render() {
    let e = this.props.e
    console.log('eeeeee', e)//如果抓到的日期是UNDEFINED再用SPLIT之類的方法會報錯
    return (
      <>
        <div className="section1-cart">
          <div
            className="container section1-cart-list"
                ...
                <div className="section1-cart-list-left-1">
                  <div className="section1-cart-list-left-image">
                    <img
                      ...
                      src={'/assets/images/dinner/' + JSON.parse(e.photo)[0]}
                      alt=""
                    />
                  </div>
                  <div className="product-category">{e.food_name}</div>
                </div>
                <div className="section1-cart-list-left-4p">
                  <p>餐廳名:{e.restaurant_name}</p>
                  <p>
                    <br /> 日期:{e.create_at.substr(0, 10)}
                    <br /> 時段:{e.book_time}
                  </p>

                  <p className="section1-cart-list-left-p"></p>
                </div>
              </div>
              ...
              <div className="col-md-5 ">
                <div className="section1-cart-list-right">
                  ...
                  <div>
                    ...
                    {((e.tip + e.product_price) * 100 * e.quantity) / 100}
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <div
                      ...
                      onClick={this.nextbuy(e.dn_goods_cart_id)}
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="122"
...
export default connect(mapstatetoprops)(Mydn)
